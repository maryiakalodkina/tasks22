...
my_array = [8, 8, 9, 9, 7, 15, 15, 2, 20, 13, 2, 24, 6, 11, 7, 10, 4, 5, 4, 22, 6, 3, 19, 14, 92, 11, 1, 5, 14, 8, 0, 1, 16, 5, 10, 13, 17, 1, 16, 17, 12, 6, 10, 0, 3, 9, 9, 3, 7, 7, 6, 6, 7, 5, 14, 18, 12, 19, 2, 8, 9, 0, 8, 4, 5]
...
def add_to_hundred (my_array):
    ...
    #creating a dictionary where all the integers from the array are keys and values = 1
    for i in my_array:
        x = 100 - i
        if x in my_dict.keys(): return True
        else:
            my_dict[i] = 1
